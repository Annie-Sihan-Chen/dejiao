(function($) {
    ...
    var thim_startertheme = {
        ready: function() {
            ...
            this.login_popup();
            // this.login_error();
            window.slide_slick_col = this.slide_slick_col
        ...
        header_menu_mobile: function() {
            ...
            $(document).on('click', '.menu-mobile-effect',
            function(e) {
                e.stopPropagation();
            ...
            $(document).on('click', '.mobile-menu-open',
            function() {
            ...
            $('.responsive .mobile-menu-container .navbar-nav>li.menu-item-has-children .icon-toggle, .mobile-menu-container .widget_nav_menu .menu-useful-links-container .menu>li.menu-item-has-children .icon-toggle').on('click',
            function() {
            ...
            $('.mobile-menu-container').on('click',
            function(e) {
                e.stopPropagation();
            })
        },
        ...
        login_popup: function() {
            $('.login-popup').on('click', '.display-box',
            function(e) {
                e.preventDefault();
        ...
        input_num_product: function() {
            try {
                $(document).on("click", '.wrap-num-product .btn-num-down',
                function() {
                ...
                $(document).on("click", '.wrap-num-product .btn-num-up',
                function() {
                    var numProduct = Number($(this).parent().find('.num-product').val());
